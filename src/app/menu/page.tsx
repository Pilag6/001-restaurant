            ...
            {menu.map((category) => (
                ...
                >
                    <div className={`text-${category.color} w-1/2`}>
                        ...
                        <button
                            className={`hidden 2xl:block py-4 shadow-[rgba(6,_24,_44,_0.4)_0px_0px_0px_2px,_rgba(6,_24,_44,_0.65)_0px_4px_6px_-1px,_rgba(255,_255,_255,_0.08)_0px_1px_0px_inset] bg-white text-black px-8`}
                        >
                            Explore
                        </button>
                    </div>
