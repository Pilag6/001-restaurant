  ...
  return (
    <div className='h-12 flex items-center justify-between text-red-500 p-4 border-b-2 border-b-red-500 uppercase md:h-16  lg:px-20 xl:px-40'>
      ...
      <div className='hidden md:flex items-center gap-4 flex-1 justify-end '>
        <div className='md:absolute top-2 right-2 lg:static flex items-center gap-2 cursor-pointer bg-green-700 py-1 px-2 rounded text-white'>
        ...
        {!user ? 
          ...
          : 
          (<Link href="/orders" className='hover:font-bold'>Orders</Link>)
        }
